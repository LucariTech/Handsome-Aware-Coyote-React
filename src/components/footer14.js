...
const Footer14 = (props) => {
  return (
    <footer className="footer14-container thq-section-padding">
      <div className="footer14-max-width thq-section-max-width">
        ...
        <div className="footer14-content">
          ...
          />
          <div className="footer14-actions">
            <div className="footer14-newsletter">
              ...
              <div className="footer14-actions1">
                <div className="footer14-form">
                  <div className="footer14-container1">
                    <input
                      type="email"
            ...
            <div className="footer14-links">
              <div className="footer14-column1">
                <strong className="thq-body-large footer14-column1-title">
                  {props.column1Title}
                </strong>
                <div className="footer14-footer-links">
              ...
              <div className="footer14-column2">
                ...
                <div className="footer14-footer-links1">
        ...
        <div className="footer14-credits">
...
Footer14.defaultProps = {
  logoAlt: 'IT Services Logo',
  column2Title: 'Contact Us',
  link10: 'Terms of Service',
  link5: 'Email Hosting',
  link3: 'Cloud Computing',
  link7: 'info@example.com',
  privacyLink: '/privacy',
  content1:
    'Contact us for a consultation on how our IT services can benefit your business.',
  link1: 'Managed IT Services',
  cookiesLink: '/cookies',
  logoSrc: 'https://presentation-website-assets.teleporthq.io/logos/logo.png',
  link6: 'Phone Systems',
  link8: '+123-456-7890',
  copyright: '© 2023 All rights reserved.',
  link2: 'Cybersecurity Solutions',
  column1Title: 'Services',
  action1: '/contact',
  content2: 'Stay connected with us on social media for updates and news.',
  link9: 'Privacy Policy',
  termsLink: '/terms',
  link4: 'Network Infrastructure',
}
